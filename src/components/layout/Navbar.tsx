      ...
      >
        ...
        <div className="p-8 border-t border-black/5 space-y-4">
            ...
            <div className="flex space-x-6">
                <a href={`https://wa.me/${settings?.whatsapp || '8801772024655'}`} target="_blank" className="text-primary hover:text-green-600 transition-colors">
                ...
                <a href={`mailto:${settings?.email || 'zevens@contact.com'}`} className="text-primary hover:text-accent transition-colors">
